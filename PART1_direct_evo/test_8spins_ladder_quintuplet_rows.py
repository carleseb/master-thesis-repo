...
# this state belongs to the first quintuplet [98:103] (103 not included)
...
for J56 in values_J56:
    # We first want to create the arbitrary Hamiltonian and print the matrix
    Jij_vector = np.array([J12zero - J56, 0, 0.6, 0, J56, 0, 0.6])
    Jij_ladder = np.array([1, 1, 1, 1, 1, 1])
    spins = len(Jij_vector) + 1
...
plt.figure()
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[0,:], label ='first sept list (label 98)')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[1,:], label ='second sept list (label 99)')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[2,:], label ='third sept list (label 100)')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[3,:], label ='fourth sept list (label 101)')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[4,:], label ='fifth sept list (label 102)')
plt.legend()
...
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[3,:] - np.transpose(energy_tracker)[2,:], label ='fourth - third')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[4,:] - np.transpose(energy_tracker)[3,:], label ='fifth - fourth')
plt.legend()
plt.xlabel('$J_{12} - J_{56}$ ($E_0$)')
plt.ylabel('energy ($E_0$)')
...
# we plot the energy of the eigenstates
plt.figure()
plt.plot(J34zero-2*np.linspace(J78ini, J78fin, number_iterations), np.transpose(energy_tracker)[0,:], label ='first sept list (label 98)')
plt.plot(J34zero-2*np.linspace(J78ini, J78fin, number_iterations), np.transpose(energy_tracker)[1,:], label ='second sept list (label 99)')
plt.plot(J34zero-2*np.linspace(J78ini, J78fin, number_iterations), np.transpose(energy_tracker)[2,:], label ='third sept list (label 100)')
plt.plot(J34zero-2*np.linspace(J78ini, J78fin, number_iterations), np.transpose(energy_tracker)[3,:], label ='fourth sept list (label 101)')
plt.plot(J34zero-2*np.linspace(J78ini, J78fin, number_iterations), np.transpose(energy_tracker)[4,:], label ='fifth sept list (label 102)')
plt.legend()
...
plt.plot(J34zero-2*np.linspace(J78ini, J78fin, number_iterations), np.transpose(energy_tracker)[3,:] - np.transpose(energy_tracker)[2,:], label ='fourth - third')
plt.plot(J34zero-2*np.linspace(J78ini, J78fin, number_iterations), np.transpose(energy_tracker)[4,:] - np.transpose(energy_tracker)[3,:], label ='fifth - fourth')
plt.legend()
plt.xlabel('$J_{34} - J_{78}$ ($E_0$)')
plt.ylabel('energy ($E_0$)')
plt.title('Differences of energy of the septuplets')
