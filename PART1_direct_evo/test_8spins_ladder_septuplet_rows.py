...
for J56 in values_J56:
    ...
    # We first want to create the arbitrary Hamiltonian and print the matrix
    #Jij_vector = np.array([0.25, 0, 0.75, 0, 0.65, 0, 0.65])
    #Jij_ladder = np.array([J12zero - J56, J56, J12zero - J56, J56, J12zero - J56, J56])
    
    #Jij_vector = np.array([2*(J12zero - J56), 0, 1.2, 0, 0.45, 0, 2*J56])
    #Jij_ladder = np.array([1, 1, 1, 1, 1, 1])
    
    #Jij_vector = np.array([2, 0, 1.5*(J12zero - J56), 0, 1.5*J56, 0, 2])
    #Jij_ladder = np.array([1, 1, 1, 1, 1, 1])
    
    #Jij_vector = np.array([2*(J12zero - J56), 0, 2*J56, 0, 2*J56, 0, 2*(J12zero - J56)])
    #Jij_ladder = np.array([1, 1, 1, 1, 1, 1])
    
    Jij_vector = np.array([2*(J12zero - J56), 0, 2*(J12zero - J56), 0, 2*(J12zero - J56), 0, 2*(J12zero - J56)])
    Jij_ladder = np.array([2*J56, 2*J56, 2*J56, 2*J56, 2*J56, 2*J56])
    spins = len(Jij_vector) + 1
...
plt.figure()
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[0,:], label ='E1')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[1,:], label ='E2')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[2,:], label ='E3')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[3,:], label ='E4')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[4,:], label ='E5')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[5,:], label ='E6')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[6,:], label ='E7')
plt.legend()
...
plt.figure()
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[1,:] - np.transpose(energy_tracker)[0,:], label ='E2 - E1')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[2,:] - np.transpose(energy_tracker)[1,:], label ='E3 - E2')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[3,:] - np.transpose(energy_tracker)[2,:], label ='E4 - E3')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[4,:] - np.transpose(energy_tracker)[3,:], label ='E5 - E4')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[5,:] - np.transpose(energy_tracker)[4,:], label ='E6 - E5')
plt.plot(J12zero-2*np.linspace(J56ini, J56fin, number_iterations), np.transpose(energy_tracker)[6,:] - np.transpose(energy_tracker)[5,:], label ='E7 - E6')
plt.legend()
plt.xlabel('$J_{12} - J_{56}$ ($E_0$)')
plt.ylabel('energy ($E_0$)')
...
plt.title('Oscillations for the septuplet subspace')
plt.xlabel('time ($t_0$)')
